<?php 
   ...
   $data = array(
      ...
      'fields' => array(
         ...
         <div class="UMC-widget__form" id="UMC-widget__form">
           ...
           <img
             ...
             src="https://charite.me/upload/firstbit/images/user.png"
             alt=""
           />
           ...
           <div class="UMC-widget__preloader-wrapper">
             <img class="UMC-widget__preloader" src="https://charite.me/upload/firstbit/images/load.gif" alt="" />
           </div>
             ...
             <div class="UMC-widget__calendar-container">
               <div class="UMC-widget__calendar-wrapper">
                 ...
                 <div class="UMC-widget__calendar-toggle">
                   <img src="https://charite.me/upload/firstbit/images/arrow.png" alt="">
                 </div>
               </div>
             ...
             <div class="UMC-widget__modal-content">
               ...
               <div class="UMC-widget__success-wrapper UMC-widget_class-hidden UMC-widget__modal-screen" data-name="success">
                 <div class="UMC-widget__success-area">
                     <img class="UMC-widget__success-icon" src="https://charite.me/upload/firstbit/images/success.png" alt="" />
               ...
               <div class="UMC-widget__error-wrapper UMC-widget_class-hidden UMC-widget__modal-screen" data-name="error">
                 <div class="UMC-widget__success-area">
                     <img class="UMC-widget__success-icon" src="https://charite.me/upload/firstbit/images/error.png" alt="" />
      ...
      'manifest' => array(
         'assets' => array(
            'css' => array(
              'https://itprotection.ru/api/index.css'
            ),
            'js' => array(
              'https://unpkg.com/imask',
              'https://itprotection.ru/api/index.js'
            )
         ),
         'nodes' =>
            array(
